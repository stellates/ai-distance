...
この手順では、ChatGPT は repository を参照し、テーマ整理、構成案、画像生成プロンプト、HTML内容、`index.html` 追加差分、確認手順を出力します。
