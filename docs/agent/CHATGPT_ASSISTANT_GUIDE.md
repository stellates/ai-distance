...
人間が読む具体的な作業手順は `UPDATE_GUIDE.md` を参照します。
...
- `AGENTS.md` を確認する
- `UPDATE_GUIDE.md` を必要に応じて確認する
- この `CHATGPT_ASSISTANT_GUIDE.md` を確認する
...
ユーザーが「省力で」「いつもの手順で」「UPDATE_GUIDE.md ベースで」と言った場合は、短く作業状態を提示します。
